# Slurm Heartbeat - Vega (Slovenia)

This directory contains configuration and scripts for running Slurm Heartbeat on the Vega supercomputer.
...
**User-space deployment (no systemd)**
...
# 3. Run setup
./examples/vega/setup.sh

# 4. Verify
./examples/vega/verify.sh
```
