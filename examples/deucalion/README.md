# Slurm Heartbeat on DEUCALION (Spain)

This directory contains configuration and scripts for running Slurm Heartbeat on the DEUCALION supercomputer in Spain.

## Overview

DEUCALION is a supercomputer in Spain, part of the EuroHPC network. This guide covers **user-space deployment**.
...
./scripts/generate_certs.sh deucalion $HOME/.slurm/heartbeat
```
...
| `config.yaml` | DEUCALION-specific configuration |
...
- [DEUCALION Supercomputer](https://www.deucalion.es/)
