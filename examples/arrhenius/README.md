# Slurm Heartbeat on ARRHENIUS (Sweden)

This directory contains configuration and scripts for running Slurm Heartbeat on the ARRHENIUS supercomputer in Sweden.

## Overview

ARRHENIUS is a supercomputer in Sweden, part of the EuroHPC network. This guide covers **user-space deployment**.
...
cp examples/arrhenius/config.yaml $HOME/.slurm/heartbeat/config.yaml
```
...
./scripts/generate_certs.sh arrhenius $HOME/.slurm/heartbeat
```
