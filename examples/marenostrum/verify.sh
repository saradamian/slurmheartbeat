#!/bin/bash
# Verification script for Slurm Heartbeat on MareNostrum5

set -e

echo "=== Slurm Heartbeat Verification for MareNostrum5 ==="
echo ""
...
if [[ -f "$CONFIG_FILE" ]]; then
    ...
    echo "  Run: ./examples/marenostrum/setup.sh"
fi
...
echo ""
if systemctl is-active --quiet slurm-heartbeat 2>/dev/null; then
    echo "✓ All checks passed. Slurm Heartbeat is running on MareNostrum5."
    echo ""
