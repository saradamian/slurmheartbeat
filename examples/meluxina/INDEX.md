# Slurm Heartbeat - MeluXina (Luxembourg)

This directory contains configuration and scripts for running Slurm Heartbeat on the MeluXina supercomputer.
...
# 3. Run setup (as root)
sudo ./examples/meluxina/setup.sh

# 4. Verify
sudo ./examples/meluxina/verify.sh
```
